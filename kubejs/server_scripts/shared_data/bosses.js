...
BossType.prototype.addDesc = function(desc) {
    this.desc += "\n" + desc
    return this
}
...
const AllBosses = [
    ...
    new BossType("末影龙", "minecraft:ender_dragon", 1.0).enableDrygmy().addDesc("当心闪电和爆炸"),
    ...
    new BossType("暗夜巫妖", "bosses_of_mass_destruction:lich", 10.0).addDesc("在主世界寒冷生物群系的巫妖塔上，把四颗灵魂之星放进祭坛召唤"), // 3000
    ...
    new BossType("混沌守卫", "draconicevolution:draconic_guardian", 1.0).withDeathReset(2).addDesc("感谢游玩本整合包！"),
    ...
    new BossType("娜迦", "twilightforest:naga", 1.0).addDesc("你的第一个暮色Boss"),
    new BossType("巫妖", "twilightforest:lich", 1.0).addDesc("需要一点魔法才能打破它的护盾"),
    new BossType("米诺菇", "twilightforest:minoshroom", 1.0).addDesc("希望你还记得迷宫的入口在哪"),
    new BossType("九头蛇", "twilightforest:hydra", 1.0).addDesc("美味的炭烤九头蛇肉排！"),
    new BossType("幻影骑士", "twilightforest:knight_phantom", 1.0).addDesc("当心这些会穿墙的家伙"),
    new BossType("暮色恶魂", "twilightforest:ur_ghast", 1.0).addDesc("也许我们需要找个地方避雨"),
