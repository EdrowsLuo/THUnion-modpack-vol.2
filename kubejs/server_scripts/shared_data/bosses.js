...
const AllBosses = [
    ...
    new BossType("混沌守卫", "draconicevolution:draconic_guardian", 1.0),
    new BossType("守卫凋灵", "draconicevolution:guardian_wither", 1.0), // not a boss
    new BossType("幼年末影龙", "endertrigon:baby_ender_dragon", 1.0), // not a boss
    ...
    new BossType("bound witch of purgatory, Saphyra", "mokels_witch_boss:witchboss", 1.0), // 暮色闭门boss，400基础血量
