...
const AllBosses = [
    ...
    new BossType("撼地斯拉", "alexscaves:tremorzilla", 0.6).withDeathReset(-1),
    new BossType("虚空蠕虫", "alexsmobs:void_worm", 10.0),// 1600每节
    new BossType("猪巫妖", "allthemodium:piglich", 1.0).withDeathReset(-1),
    new BossType("荒野奇美拉", "ars_nouveau:wilden_boss", 2.0),// 2000 / 500每阶段
    new BossType("宝箱怪", "artifacts:mimic", 10.0).withDeathReset(-1), // 600
    new BossType("无尽傀儡", "avaritia:infinity_golem", 1.0).withDeathReset(-1),
    ...
    new BossType("守卫凋灵", "draconicevolution:guardian_wither", 1.0).withDeathReset(-1),
    new BossType("幼年末影龙", "endertrigon:baby_ender_dragon", 1.0).withDeathReset(-1),
    ...
    new BossType("蜜蜂女王", "the_bumblezone:bee_queen", 100.0).enableDrygmy().withDeathReset(-1),
    new BossType("宇宙水晶实体", "the_bumblezone:cosmic_crystal_entity", 1.0).withDeathReset(-1),
    ...
    new BossType("暮初恶魂", "twilightforest:ur_ghast", 1.0),
